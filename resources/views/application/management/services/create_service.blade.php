                ...
                <div class="ui-grid ui-grid-responsive">
                    ...
                    <form id="createServiceForm" name="createServiceForm" method="POST" action="{{ route('store_service') }}" class="ajaxJsonForm form-horizontal">
                        ...
                        <div class="ui-grid-row">
                            ...
                            <div class="ui-grid-col-10">
                                <input id="slogan" name="slogan" type="text" autocomplete="off" class="form-control" />
                            </div>                                                                                                                
                        </div>
                        <div class="ui-grid-row">
                            <div class="ui-grid-col-2"></div>
                        ...
                        <fieldset>
                            ...
                            <div class="ui-grid-row">
                                ...
                                <div class="ui-grid-col-10">   
                                    <input id="website_bg_color" name="website_bg_color" type="text" autocomplete="off" class="form-control" />                                
                                </div>                                                                                                                
                            </div>
                            <div class="ui-grid-row">
                                <div class="ui-grid-col-2"></div>
                            ...
                            <div class="ui-grid-row">
                                ...
                                <div class="ui-grid-col-10">                                                                                                
                                    <textarea id="website_html_content" name="website_html_content" class="form-control html_editor" ></textarea>
                                </div>                                                                                                                
                            </div>
                            <div class="ui-grid-row">
                                <div class="ui-grid-col-2"></div>
